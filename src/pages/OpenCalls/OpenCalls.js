      ...
      <Tabs defaultTab={this.state.defaultTab}
        ...
        <span>
          ...
          <TabPanel tabId="stickers">
            ...
            <p className='tab-paragraph'>Last year Kernelcon had 12 unique stickers that our most creative indivduals (and sometimes their family members) spent hours designing. Attendees received a handful of the same unique stickers so they could trade with others and collect the whole set.  It was one of our most talked about swag items, and a fun way to meet new people and get your sticker on.</p>
